...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Retsep malumotlarini kiritish' }),
    (0, common_1.Post)(),
...
__decorate([
    ...
    (0, _decorators_1.Protected)(true),
    (0, _decorators_1.Roles)([user_1.UserRoles.admin, user_1.UserRoles.user]),
    (0, swagger_1.ApiOperation)({ summary: 'Barcha retseplarni olish' }),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, _decorators_1.Protected)(true),
    (0, _decorators_1.Roles)([user_1.UserRoles.admin, user_1.UserRoles.user]),
    (0, swagger_1.ApiOperation)({ summary: 'Bir dona retsep malumotlarini olish' }),
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    (0, _decorators_1.Protected)(true),
    (0, _decorators_1.Roles)([user_1.UserRoles.admin, user_1.UserRoles.user]),
    (0, swagger_1.ApiOperation)({ summary: 'Retsep malumotlarini o`zgartirish' }),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, _decorators_1.Protected)(true),
    (0, _decorators_1.Roles)([user_1.UserRoles.admin, user_1.UserRoles.user]),
    (0, swagger_1.ApiOperation)({ summary: 'Retsep malumotoalrini o`chirish' }),

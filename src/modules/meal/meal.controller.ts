...
import { MealService } from './meal.service';
import { Meal } from './model/meal.model';
import { ApiOperation, ApiTags, ApiResponse, ApiConsumes, ApiBody, ApiParam, ApiBearerAuth } from '@nestjs/swagger';
import { CreateMealDto, UpdateMealDto } from './dtos';
...
export class MealController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Barcha taomlar allMeals ro‘yxati.',
  })
  @Get()
  ...
  @ApiParam({
    name: 'mealId',
    description: 'O‘zgartirilayotgan taomning IDsi',
    example: 1,
  })
  @ApiBody({
    schema: {
  ...
  @ApiOperation({ summary: 'Taomn malumotlarini o‘chirish' })
